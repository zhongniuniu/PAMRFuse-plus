...
if __name__ == '__main__':
    ...
    ir_path = "/public2/zhongyutian/UMF-CMGR-main/datasets/PATMRI/trainB"
    vi_path = "/public2/zhongyutian/UMF-CMGR-main/datasets/PATMRI/trainA"

    ir_file_list = sorted(os.listdir(ir_path))
    vi_file_list = sorted(os.listdir(vi_path))

    ir_map_path = "/public2/zhongyutian/UMF-CMGR-main/datasets/PATMRI/ir_map"
    vi_map_path = "/public2/zhongyutian/UMF-CMGR-main/datasets/PATMRI/vi_map"
